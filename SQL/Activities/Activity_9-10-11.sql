...
SELECT a.customer_name AS "Customer_Name", a.city, b.salesman_name AS "Salesman_Name", b.commission FROM customers a 
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;

-- Write an SQL statement to make a list in ascending order for the customer who holds a grade less than 300 
SELECT a.customer_name, a.city, a.grade, b.salesman_name AS "Salesman_Name", b.salesman_city FROM customers a 
...
SELECT a.customer_name AS "CustomerName", a.city, b.salesman_name AS "Salesman_Name", b.commission FROM customers a 
INNER JOIN salesman b ON a.salesman_id=b.salesman_id 
